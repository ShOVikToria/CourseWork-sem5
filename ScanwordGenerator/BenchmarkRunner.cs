...
namespace ScanwordGenerator
{
    ...
    {
        // Додано параметр imagePrefix, щоб знати, в якій папці шукати картинки
        public static void RunFullTest(ScanwordService service, List<WordData> words, string imagePrefix)
        {
                ...
                //{
                    foreach (var attempts in attemptsOptions)
                    {
                        ...
                        if (resultGrid != null)
                        {
                            ...
                            wordsCount = CountFilledCells(resultGrid);
                        }
        ...
        // Метод для розрахунку щільності
